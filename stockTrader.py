...
def menu():
    ...
    while(True):
        display_main_menu()
        choice = int(input('Welcome to the Stock Market Simulation Game! \n Enter your choice: '))
        if(choice == 0):
            print("This game is a simplified simulation of how stocks work in the real world. You have a 1000 dollars"
                  ...
                  "\nwill move up and down randomly. Good luck, and happy trading!")
            menu()
        elif(choice == 1):
            runGame()
        elif (choice == 2):
            print("This simulation was created by Jay Yunas, an undergraduate at Connecticut College in the Fall of 2019.")
            menu()
        elif (choice == 3):
            return "Goodbye!"
        print()
